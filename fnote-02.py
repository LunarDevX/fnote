...
class fnote:
    ...
    def __init__(self):
        ...
        self.logo = "logo.txt"
        self.hyphen = "-" * 50
        self.menu = {"a": self.add_note, "e": self.edit_note, "q": self.stop_program}
        self.finished = True
    ...
    def add_note(self):
        ...
        print()
        sleep(0.50)
        print("Enter tag (press <<Enter>> when finished)")
        print(self.hyphen)
        tag = input()
    ...
    def edit_note(self):
        ...
        if self.check_id_in_database(note_id): 
            ...
            tag = self.get_note_database(note_id)
    ...
    def edit_get_note_id(self):
        ...
        print(self.hyphen)
        note_id = input("Type the id of the note you want to edit: ")
        # note_id = input()
